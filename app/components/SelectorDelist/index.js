          ...
          Object.keys(obj[i][j][k]).forEach((l) => {
            ...
            Object.keys(obj[i][j][k][l]).forEach((m) => {
              ...
              Object.keys(obj[i][j][k][l][m]).forEach((n) => {
                need_state.push(n);
                Object.keys(obj[i][j][k][l][m][n]).forEach(o => {
...
//Taking unique of array
    ...
    let parent_supplier_Unique = unique(parent_supplier);
    let buyer_Unique = unique(buyer);
    let junior_buyer_Unique = unique(junior_buyer);
    let need_state_Unique = unique(need_state);
    let brand_indicator_Unique = unique(brand_indicator);


    return {
      buying_controller: Object.keys(obj),
      parent_supplier: parent_supplier_Unique,
      buyer: buyer_Unique,
      junior_buyer: junior_buyer_Unique,
      need_state: need_state_Unique,
