...
class NewSelector extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  componentDidMount = () => {
    ...
    // console.log("side filer", this.props)
  };
  ...
  render() {
    ...
    let data = this.props.sideFilter.data, hierarchyList = [], selectedList = [];
     // console.log("inside selectors", data);
    if (!data) {
