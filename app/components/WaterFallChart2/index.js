...
class WaterFallChart2 extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  createChart = (data, id, yAxisName, formatter, positive_text, negative_text, total_text) => {
...
// });
    ...
    bar.append('text')
      .attr('x', (x.bandwidth() / 2 - margin.right / 2))
      ...
      // .attr('y', (d) => y(d.end) + 5)
      .attr('y', (d) => {
        return (y((((d.end - d.start > 0 ) ? d.end : d.start ))) - 5)
      })
