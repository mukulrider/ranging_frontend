...
class MultilineOrdinalChart extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
    createChart = (data2,chart_id,axis_prefix) =>{
    ...
    componentDidMount = () => {
        ...
        this.createChart(this.props.data[0],this.props.data[1],this.props.data[2])
    };
  ...
  render() {
      ...
      <div>
        <div>
          <svg id={this.props.data[1]} width="500" height="320" fontFamily="sans-serif" fontSize="10"> </svg>
        </div>
      </div>
    );
  }
