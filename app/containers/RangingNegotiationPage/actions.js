...
import {
  GENERATE_CHECKED_LIST, DEFAULT_ACTION,FETCH_DATA, FETCH_DATA_SUCCESS , URL_PARAM , WEEK_FETCH, GENERATE_FILE,
  GENERATE_TABLE, GENERATE_TABLE_SUCCESS, SAVE_BUBBLE_PARAM2,
  ...
  GENERATE_TEXTBOX_QUERY_STRING,RESET_CLICKED, GENERATE_URL_PARAMS_DATA, GENERATE_URL_PARAMS_DATA_SUCCESS,RADIO_CHECK_PARAM,
  LOADING_INDICATION,LOADING_INDICATION_TEXT, OPEN_MODAL
} from './constants';
...
export function onGenerateUrlParamsData() {
  return {
