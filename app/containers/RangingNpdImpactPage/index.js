...
import {
  ...
  saveWeekParam,checkboxChange,pageLoadSelectFilterIndicator,
...
export class RangingNpdImpactPage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  constructor(props) {
    super(props);
    this.state = {smShow: false, lgShow: false, showPreviousChanges: true, activeKey: '1', activePage: 1,activePageSupTable: 1};
